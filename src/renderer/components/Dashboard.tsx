    ...
    <div className="flex-1 flex flex-col overflow-hidden bg-[var(--bg-app)] select-none text-[13px] text-[var(--text-main)] font-sans theme-transition">
      ...
      <div className="h-[48px] bg-[var(--bg-panel)] border-b border-[var(--border-color)] flex items-center px-5 gap-2.5 shrink-0 select-none">
        ...
        <div className="relative">
          <svg 
            className="absolute left-2.5 top-1/2 transform -translate-y-1/2 text-[var(--text-subtle)]" 
            width="12" 
            height="12" 
            viewBox="0 0 12 12" 
            fill="none" 
      ...
      <div className="flex-1 overflow-y-auto p-5 flex flex-wrap gap-4 content-start items-start">
      ...
      {/* Footer bar */}
      <div className="h-6 bg-[var(--bg-panel-header)] border-t border-[var(--border-color)] flex items-center px-4 justify-between shrink-0 text-[11.5px] text-[var(--text-muted)] font-medium">
        <span>
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className="hover:text-[var(--text-main)] cursor-pointer border-none bg-transparent text-[11.5px] text-[var(--text-muted)] font-medium outline-none transition-colors"
          >
            ⚙ Settings
          </button>
